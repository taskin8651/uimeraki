...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Add Product Category</h2>

        <p class="admin-page-subtitle">
            Create a new product category for frontend product sections
        </p>
    </div>
</div>
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    @else
                        <p class="field-hint">Example: pharma, food-dairy, cosmetics</p>
                    @endif
                </div>
                ...
                <div class="field-group">
                    ...
                    @else
                        <p class="field-hint">Use FontAwesome class, example: fas fa-box-open</p>
                    @endif
                </div>
            ...
            <div class="form-card-body">
                ...
                <div class="form-info-box">
                    ...
                    <p class="field-hint mt-2">
                        Active categories will be visible on frontend.
                    </p>
                </div>

    ...
    <div class="admin-form-grid">
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    @else
                        <p class="field-hint">Leave blank to auto-generate from title.</p>
                    @endif
                </div>
                ...
                <div class="field-group">
                    ...
                    <textarea name="tags"
                              id="tags"
                              rows="3"
                              placeholder="Blister foils, Strip packs, Barrier, Traceability"
                              class="field-input {{ $errors->has('tags') ? 'error' : '' }}">{{ old('tags') }}</textarea>
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    <label class="field-label" for="image">Industry Image</label>
